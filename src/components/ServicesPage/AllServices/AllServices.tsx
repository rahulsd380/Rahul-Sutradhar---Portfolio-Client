    ...
    <Container>
      <div className="flex flex-col gap-10 mt-40 lg:mt-56 xl:mt-80">
        {allServices?.map((service) => (
          <div
            key={service?.title}
            className="p-4 md:p-6 lg:p-10 rounded-2xl lg:rounded-4xl border border-primary-20/20 hover:border-primary-25 transition duration-300 flex flex-col lg:flex-row items-center justify-between gap-10 relative"
          >
            <Image
            ...
            <div className="flex flex-col items-end justify-between h-full gap-10 lg:gap-20">
              <Image src={service?.image} alt={""} className="h-full" />
              <Link href={"/"}>
