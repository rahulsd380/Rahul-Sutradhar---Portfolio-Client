        ...
        <div className="flex gap-3 mt-[70px]">
          ...
          <div className="w-[70%] space-y-3">
            ...
            <div className="bg-neutral-55 rounded-[20px] p-6 relative overflow-hidden max-h-[330px]">
              ...
              />
              <div>
                <h2 className="font-Uncut-Sans text-[32px] font-semibold text-white leading-9">
                  Local Businesses
                </h2>
                <p className="font-Inter text-lg text-neutral-35 leading-6 mt-2">
            ...
            <div className="bg-neutral-55 h-[228px] rounded-[20px] p-6 relative overflow-hidden">
              ...
              <div className="flex flex-col items-center justify-center text-center h-full">
                <h2 className="font-Uncut-Sans text-[48px] font-semibold text-white leading-9">
                  Local Businesses
                </h2>
                <p className="font-Inter text-lg text-neutral-35 leading-6 mt-4">
                  Turn your website into a lead machine.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <div className="bg-neutral-55 h-[228px] rounded-[20px] p-6 relative overflow-hidden w-full">
                ...
                <div className="flex flex-col items-center justify-center text-center h-full gap-6">
                  <h2 className="font-Uncut-Sans text-2xl font-semibold text-white leading-9">
              ...
              <div className="bg-neutral-55 h-[228px] rounded-[20px] p-6 relative overflow-hidden w-full">
                ...
                <div className="flex flex-col items-center justify-center text-center h-full gap-2">
                  ...
                  <div>
                    <h2 className="font-Uncut-Sans text-[58px] font-semibold text-white">
                      100+
                    </h2>
                    <h3 className="font-Uncut-Sans text-[32px] text-white leading-0">
                      Happy clients
                    </h3>
                  </div>
                </div>
          ...
          {/* Right Side */}
          <div className="w-[30%] space-y-3 h-full">
            {/* Right-Card-1 */}
