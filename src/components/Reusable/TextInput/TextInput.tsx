    ...
    return (
      <div className="flex flex-col gap-2 font-Nunito w-full">
        ...
        <input
          ...
          ref={ref}
          disabled={isDisabled}
          className={`w-full px-4 py-3.5 rounded-lg  border leading-[18px] focus:outline-none focus:border-primary-10 transition duration-300 ${isDisabled ? "cursor-not-allowed" : "bg-white"} ${
            error ? "border-red-500" : "border-neutral-55/20"
          }`}
          {...rest}
        />
        {error?.message && (
