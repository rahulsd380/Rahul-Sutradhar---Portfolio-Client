  ...
  return (
    <Container>
      <div className="pt-[150px] pb-[100px]">
        ...
        <div className="bg-neutral-85 border border-neutral-35/20 p-12 rounded-xl font-Inter mt-13 lg:mt-[70px] relative">
          ...
          <div className="flex gap-5 flex-col w-full relative">
            {accordingData?.map((according, index) => (
              ...
              >
                ...
                >
                  <p className="text-neutral-35 overflow-hidden">
